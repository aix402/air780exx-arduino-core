...
- TCP, TLS, UDP, and first-pass network time helpers are now hardware-
  observed, but higher-level CA validation and MQTTS still need separate
  runtime validation.
